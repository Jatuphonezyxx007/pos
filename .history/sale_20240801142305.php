...
<table class="table table-bordered" width="100%" id="calcu">
    ...
    <tr>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('7')">7</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('8')">8</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('9')">9</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('1000')">1000</button></td>
    </tr>
    <tr>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('4')">4</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('5')">5</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('6')">6</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('500')">500</button></td>
    </tr>
    <tr>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('1')">1</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('2')">2</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('3')">3</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('100')">100</button></td>
    </tr>
    <tr>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('.')">.</button></td>
        <td><button class="btn btn-outline-secondary w-100 fs-4" onclick="addToResult('0')">0</button></td>
        <td><button class="btn btn-secondary w-100 fs-4" onclick="deleteLastChar()">ลบ</button></td>
        <td><button class="btn btn-primary w-100 fs-4" onclick="calculateTotal()">เต็ม</button></td>
    </tr>
</table>
</div>
...
function calculateTotalPrice() {
    // สมมติว่าเป็นการคำนวณราคารวมของสินค้าในตะกร้า
    return 1000; // ปรับให้ตรงกับความต้องการของคุณ
}
