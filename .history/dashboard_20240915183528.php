...
const labels = <?php echo json_encode($dates); ?>;
  ...
  const salesData = <?php echo json_encode($salesData); ?>; // { "Employee A": [10, 20, 30], "Employee B": [15, 25, 35] }
  
  const datasets = Object.keys(salesData).map((employee, index) => ({
    label: employee,
    data: salesData[employee],
    fill: false,
