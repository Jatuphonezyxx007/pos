    ...
    <?php if (isset($data)) { ?>
      ...
      <div class="col-md-12">
        <div class="page-header-title border-bottom pb-2 mb-2 d-flex align-items-center">
          ...
          <h4 class="mb-0">แก้ไขข้อมูลลูกค้า : <?=$data['customer_name'];?> <?=$data['customer_last'];?></h4>
        </div>
      </div>
        ...
        <div class="col-md-12">
          ...
          <div class="card-header">
            <div class="row align-items-center">
              ...
              <div class="col-9">
              <input class="form-control" type="text" name="ep_id" placeholder="<?= $data['customer_id']; ?>" aria-label="Disabled input example" disabled>              
            </div>          
            </div>
          </div>
            ...
            <div class="card-body pc-component">
              ...
              <div class="col-5">
                <input name="cus_name" type="text" class="form-control" value="<?= $data['customer_name']; ?>"> 
              </div>
              <div class="col-4">
                <input name="cus_last" type="text" class="form-control" value="<?= $data['customer_last']; ?>"> 
              </div>                    
            </div>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-9">
                <input name="cus_taxid" type="text" class="form-control" value="<?= $data['customer_taxID']; ?>"> 
              </div>          
            </div>
            <br>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-9">
                <input name="cus_email" type="text" class="form-control" value="<?= $data['customer_email']; ?>"> 
              </div>          
            </div>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-9">
                <input name="cus_phone" type="text" class="form-control" value="<?= $data['customer_phone']; ?>"> 
              </div>          
            </div>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-9">
              <textarea name="cus_address" class="form-control" aria-label="With textarea"><?= $data['customer_address']; ?></textarea>
             </div>          
            </div>
