                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center" width="15%">วันที่ (สร้าง)</th>
                                        <th class="text-end" width="12%">ราคารวม (บาท)</th>
                                        <th class="text-center" width="20%">พนักงาน</th>
                                        <th class="text-center" width="13%">ชำระโดย</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start text-muted">
                                            <small><?= date('l d F Y H:i:s', strtotime($data['order_date'])); ?></small>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" class="btn btn-success btn-sm" onClick="window.open('bill_print.php?b=<?=$data['order_id'];?>', '_blank', 'width=760,height=560')">ใบเสร็จ</a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
