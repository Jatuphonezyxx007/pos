...
if (mysqli_query($conn, $sql)) {
    ...
    echo "    setTimeout(function() {";
    echo "      window.location.href = 'up_test.php?id=$id';"; // เปลี่ยนไปที่หน้า update_product.php พร้อมส่งค่า product_id ที่ถูกต้อง
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">ขนาด </h5>
        <input type="text" class="form-control" id="quantity-<?= $row['size_id']; ?>" name="size_name" value="<?= $row['size_name']; ?>">
