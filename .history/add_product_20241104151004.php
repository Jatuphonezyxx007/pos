...
<!-- [ Header ] end -->
  ...
  <button type="button" class="btn btn-secondary mt-2" onclick="addSize()">เพิ่มขนาดสินค้า</button>
                      ...
                      <label for="p_product" class="form-label">เพิ่มขนาดสินค้า</label>
                    <div class="row g-2">
                      <div class="col-md">
                        <div class="form-floating">
                          <input type="text" name="p_price" class="form-control" id="p_product" placeholder="ราคา" required>
...
//เพิ่มขนาด
  ...
  function addSize() {
    ...
    row.innerHTML = `
      <div class="col-md-3">
        <input type="text" name="size[${sizeCount}][size]" class="form-control" placeholder="ขนาดสินค้า" required>
      </div>
      <div class="col-md-2">
        <input type="number" name="size[${sizeCount}][quantity]" class="form-control" placeholder="จำนวน" required>
      </div>
      <div class="col-md-3">
        <input type="number" name="size[${sizeCount}][restock]" class="form-control" placeholder="จุดรีสต๊อก" required>
      </div>
      <div class="col-md-3">
        <input type="number" step="0.01" name="size[${sizeCount}][price]" class="form-control" placeholder="ราคาต่อหน่วย (รวมภาษี)" required>
      </div>
      <div class="col-md-1">
