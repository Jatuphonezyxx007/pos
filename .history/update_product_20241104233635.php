...
if (isset($_GET['id'])) {
  ...
  $sql = "SELECT products.*, size.*, type.type_name 
          FROM products 
          LEFT JOIN size ON products.id = size.product_id 
  ...
  if ($rs->num_rows > 0) {
      // ดึงข้อมูลที่ได้จากการ query
      while ($data = $rs->fetch_array(MYSQLI_ASSOC)) {
          // แสดงข้อมูลของแต่ละขนาด
          echo '<div class="col-2">
                  <div class="row g-2 mb-2">
                    <div class="form-floating">
                      <input type="text" name="size_name[]" class="form-control" id="size_name" placeholder="ชื่อขนาด" value="'. $data['size_name'] .'" required>
                ...
                <div class="col-2">
                  <div class="row g-2 mb-2">
                    <div class="form-floating">
                      <input type="number" name="size_qty[]" class="form-control" id="size_qty" placeholder="จำนวน" value="'. $data['qty'] .'" required>
                ...
                <div class="col-2">
                  <div class="row g-2 mb-2">
                    <div class="form-floating">
                      <input type="number" name="size_restock[]" class="form-control" id="size_restock" placeholder="จุดรีสต๊อก" value="'. $data['re_stock'] .'" required>
                ...
                <div class="col-2">
                  <div class="row g-2 mb-2">
                    <div class="form-floating">
                      <input type="text" name="size_price[]" class="form-control" id="size_price" placeholder="ราคา" value="'. $data['price'] .'" required>
      ...
      echo "No sizes available for this product."; // หากไม่มีข้อมูล size
  }
    ...
    <div class="card-body pc-component">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-2">
          ...
          <div class="form-floating">
            <input type="text" name="size_name" class="form-control" id="size_name" placeholder="ชื่อขนาด" value="<?= $data['size_name']; ?>" required>
            <label for="floatingInputGrid">ชื่อขนาด</label>
          </div>
        </div>
        </div>
        <div class="col-2">
          ...
          <div class="form-floating">
            <input type="number" name="size_qty" class="form-control" id="size_qty" placeholder="จำนวน" value="<?= $data['qty']; ?>" required>
            <label for="floatingInputGrid">จำนวน</label>
          </div>
        </div>
        </div>
        <div class="col-2">
          ...
          <div class="form-floating">
            <input type="number" name="size_restock" class="form-control" id="size_restock" placeholder="จุดรีสต๊อก" value="<?= $data['re_stock']; ?>" required>
            <label for="floatingInputGrid">จุดรีสต๊อก</label>
          </div>
        </div>
        </div>
        <div class="col-2">
          ...
          <div class="form-floating">
            <input type="text" name="size_price" class="form-control" id="size_price" placeholder="ราคา" value="<?= $data['price']; ?>" required>
            <label for="floatingInputGrid">ราคารวมภาษี</label>
          </div>
        </div>
        </div>
        <div class="col-2">
          <div class="row g-2 mb-2">
            <a>
              <button type="button" class="btn btn-danger"><i class="ph ph-trash"></i>
              </button>
            </a>
          </div> <!-- ปิดแถวของปุ่ม -->
        </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-2">
            <button type="button" class="btn btn-success"><i class="ph ph-plus-circle"></i></button>          
          </div>          
        </div>
