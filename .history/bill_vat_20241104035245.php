...
if (isset($_GET['b'])) {
    ...
    $sql = "SELECT o.*, ad.*, pay.*, com.com_phone, com.com_name, com.tax_id, pay.paymethod_name, pm.emp_name, pm.emp_last
            FROM orders o
...
<div class="row">
    <div class="col-12">
        <div class="text-start font-header">
            ...
            <p class="mb-1">เลขที่ประจำตัวผู้เสียภาษีอากร: <?= htmlspecialchars($data['tax_id']); ?></p>
...
<table class="table" width="100%">
  ...
  <tbody>
    ...
    <p class="mb-1">เลขที่ใบกำกับภาษี <?= htmlspecialchars($data['order_id']); ?></p>
    <p class="mb-1">เลขเล่มที่ใบกำกับภาษี  001</p>
    <p class="mb-1">วันที่ <?= htmlspecialchars($formattedDate); ?></p>
    </div>
    ...
    <tbody>
        ...
        <tr>
    <td rowspan="2" colspan="2" class="text-start font-table"></td> <!-- ผสานเซลล์ให้ครอบคลุมทั้งสองแถว -->
    <td colspan="2" class="text-center font-table">รวม</td>
    <td class="text-center font-table"><?= number_format($totalBeforeTax, 2); ?></td> <!-- ราคารวมก่อนภาษีทั้งหมด -->
</tr>
<tr>
    <td colspan="2" class="text-center font-table">ภาษีมูลค่าเพิ่ม (7%)</td>
    <td class="text-center font-table"><?= number_format($taxAmount, 2); ?></td> <!-- แสดงภาษี 7% -->
</tr>

        <tr>
            <td colspan="2" class="text-center font-table"><?= convert_number_to_words($total); ?>บาทถ้วน</td>
            <td colspan="2" class="text-center font-table">รวมเงินทั้งสิ้น (รวมภาษี)</td>
            <td class="text-center font-table"><strong><?= number_format($total, 2); ?></strong> </td> <!-- ราคารวมหลังรวมภาษี -->
        </tr>
    </tbody>
</table>
    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col text-center font-table">
                <p>ลงชื่อ ______________________________________________________________ ผู้รับสินค้า</p>
            </div>
            <div class="col text-center">
            <p>ลงชื่อ ______________________________________________________________ ผู้ขาย</p>
            </div>
            <!-- <div class="col text-center">
