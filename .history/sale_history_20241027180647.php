...
<div class="pagination-container text-center mt-3">
    ...
    if ($totalPages <= 4) {
        // ถ้ามีหน้ามากกว่าหรือเท่ากับ 1 และน้อยกว่าหรือเท่ากับ 4 แสดงหมายเลขหน้า 1 ถึง $totalPages
        for ($i = 1; $i <= $totalPages; $i++): ?>
            <a href="?page=<?= $i; ?>" class="btn btn-light <?= ($i == $page) ? 'active' : ''; ?>"><?= $i; ?></a>
        <?php endfor;
    } elseif ($totalPages <= 10) {
        // ถ้ามีหน้ามากกว่า 4 แต่ไม่เกิน 10 แสดงหมายเลขหน้า 1 ถึง 10
        for ($i = 1; $i <= 10; $i++): ?>
            <?php if ($i <= $totalPages): ?>
                <a href="?page=<?= $i; ?>" class="btn btn-light <?= ($i == $page) ? 'active' : ''; ?>"><?= $i; ?></a>
            <?php endif; ?>
        ...
        // ถ้ามีหน้ามากกว่า 10 แสดงหมายเลขหน้า 1 ถึง 5
        for ($i = 1; $i <= 5; $i++): ?>
            <a href="?page=<?= $i; ?>" class="btn btn-light <?= ($i == $page) ? 'active' : ''; ?>"><?= $i; ?></a>
        <?php endfor; ?>
        <!-- แสดง ... ถ้ามีหน้ามากกว่า 5 -->
