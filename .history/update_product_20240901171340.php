  ...
  <div class="col-9">
    <div class="row g-2 mb-2">
      ...
      if (isset($data['id'])) {
        ...
        $id = $data['id'];
        $query = "SELECT size_name FROM size WHERE id = $id";
        ...
        if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            ?>
            <div class="col-4">
              <button type="button" class="btn btn-outline-secondary w-100"><?= $row['size_name']; ?></button>
            </div>
            <?php
            $count++;
      ...
      <!-- ปุ่ม + เพิ่มขนาด -->
      <div class="col-4">
        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#exampleModal">+ เพิ่มขนาด</button>
      </div>
    </div> <!-- ปิดแถวของปุ่ม -->
  </div> <!-- ปิด col-9 -->
</div> <!-- ปิดแถวหลัก -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="mb-3">
            <label for="sizeName" class="form-label">เพิ่มขนาดใหม่</label>
            <input type="text" class="form-control" id="sizeName" placeholder="ขนาด/สี">
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">บันทึกขนาดสินค้า</button>
      </div>
    </div>
  </div>
</div>
