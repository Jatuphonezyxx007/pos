  ...
  <tbody>
    ...
    <thead>
        <tr>
            ...
            <td width="45%" class="text-center small"><strong>รายการสินค้า</strong><br>
                <span class="small">Description</span>
            </td>
            <td width="15%" class="text-center small"><strong>จำนวน</strong><br>
                <span class="small">Quantity</span>
            </td>
            <td width="15%" class="text-center small"><strong>ราคา / หน่วย</strong><br>
                <span class="small">Unit Price</span>
            </td>
            <td width="15%" class="text-center small"><strong>รวม</strong><br>
