...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['barcode'])) {
  ...
  // ตรวจสอบว่ามีข้อมูลในตาราง products หรือไม่
  ...
  if ($result) {
      ...
      echo json_encode(['exists' => false]); // ถ้าไม่สามารถ query ได้
  }
  exit;
}
...
<div class="col-12 col-sm-8 col-md-12">
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="col-3">
        <a id="checkBarcodeBtn" href="#" type="button" class="btn btn-success w-100">ตรวจสอบ</a>
    </div>                   
</div>

<div id="barcodeMessage" class="mt-2"></div> <!-- Div สำหรับแสดงข้อความ -->
...
document.getElementById('checkBarcodeBtn').addEventListener('click', function(e) {
    ...
    .catch(error => {
        ...
        var messageDiv = document.getElementById('barcodeMessage');
        messageDiv.innerHTML = '<span class="text-danger">เกิดข้อผิดพลาดในการตรวจสอบ</span>';
    });
});
