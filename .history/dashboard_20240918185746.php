...
$month_message = "ยอดขายมากที่สุดในเดือน $month_name_thai";
    ...
    <div class="card bg-grd-success order-card">
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card bg-grd-warning order-card">
            <div class="card-body">
              <h6 class="text-white"><?php echo htmlspecialchars($month_message, ENT_QUOTES, 'UTF-8'); ?></h6>              <h2 class="text-end text-white"><i class="feather icon-repeat float-start"></i><span><?php echo number_format($max_total_sales, decimals:2); ?> บาท</span></h2>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="card bg-grd-primary order-card">
            <div class="card-body">
              ...
              <p class="m-b-0">จำนวนที่ขายไปในเดือนนี้<span class="float-end"><?php echo ($total_days); ?> บิล</span></p>
            </div>
          </div>
        </div>
        <!-- Recent Orders end -->
