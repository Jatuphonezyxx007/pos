          ...
          <div class="card-header">
            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <select class="form-select" id="role" aria-label="role" name="ep_role" onchange="replaceWithInput()">
  <?php
    include("connectdb.php");
...
function replaceWithInput() {
    ...
    if (select.value === "other") {
        // สร้าง input element ขึ้นมาใหม่
        var input = document.createElement("input");
        input.type = "text";
        input.className = "form-control"; // เพิ่ม class form-control ให้ input
        input.name = "other_role"; // ตั้งชื่อให้กับ input
        input.placeholder = "กรอกข้อมูลอื่นๆ";
