                    ...
                    <table class="table table-striped table-bordered table-hover">
                      <thead class="table-dark">
                        <tr>
                          ...
                          <th scope="col" class="text-start">วันที่ (สร้าง)</th>
                          <th scope="col" class="text-end">ราคารวม (บาท)</th>
                          <th scope="col" class="text-center">พนักงาน</th>
                          <th scope="col" class="text-center">ชำระโดย</th>
                      ...
                      ?>
                          <tr>
                            <td class="text-center"><a href="history_detail.php?a=<?=$data['order_id'];?>">รายละเอียด</a></td>
                            ...
                            <td class="text-center">
                              <a href="delete.php?id=<?=$data['order_id'];?>" class="btn btn-danger btn-sm" onClick="return confirm('ยืนยันการลบ ?');">คืนสินค้า</a>
                              <a class="btn btn-success btn-sm" onClick="window.open('bill_print.php?b=<?=$data['order_id'];?>', '_blank', 'width=760,height=560')">ใบเสร็จ</a>
                            </td>
                          </tr>
                      <?php  
                          }
