...
<table width="100%" id="calcu"> 
    ...
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('7')">7</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('8')">8</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('9')">9</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('1000')">1000</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('4')">4</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('5')">5</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('6')">6</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('500')">500</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('1')">1</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('2')">2</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('3')">3</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('100')">100</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('.')">.</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="appendNumber('0')">0</button></td> 
        <td width="20%"><button class="btn btn-secondary w-100" onclick="deleteLastChar()"><i class="ph ph-backspace"></i></button></td> 
        <td width="40%"><button class="btn btn-primary w-100" onclick="showTotal()">เต็ม</button></td> 
    </tr>
</table>
...
// ฟังก์ชันเพื่อเพิ่มตัวเลขไปยังช่องผลลัพธ์
...
// ฟังก์ชันเพื่อคำนวณราคารวมและแสดงในช่องผลลัพธ์
function calculateTotal() {
    let result = document.getElementById('result').value;
    let total = 0;

    // เพิ่มค่าในช่องผลลัพธ์ไปที่ตัวแปร total
