...
<table width="100%" id="calcu"> 
    ...
    <tr> 
        ...
        <td><button class="btn btn-secondary w-100">1000</button></td> 
    </tr> 
    <tr> 
        ...
        <td><button class="btn btn-secondary w-100">500</button></td> 
    </tr> 
    <tr> 
        ...
        <td><button class="btn btn-secondary w-100">100</button></td> 
    </tr> 
    <tr> 
        <td><button class="btn btn-secondary w-100">.</button></td> 
        <td><button class="btn btn-secondary w-100">0</button></td> 
        <td><button class="btn btn-secondary w-100"><i class="ph ph-backspace"></i></button></td> 
        <td><button class="btn btn-secondary w-100">เต็ม</button></td> 
    </tr>
</table>
