...
$is_search_button_clicked = isset($_POST['search_button']); // ตรวจสอบการกดปุ่มค้นหา

// ถ้าไม่มีการกดปุ่มค้นหาและไม่มีวันที่เลือก ให้ใช้เดือนและปีปัจจุบัน
...
// ตรวจสอบเงื่อนไขวันที่ ถ้ามีการกดปุ่มค้นหา ให้แสดงยอดขายทั้งหมดในระบบ
if (!$is_search_button_clicked && empty($selected_date)) {
