...
// แสดงข้อมูล
// echo "<h3>Welcome, $aname ($role_name)</h3>"; // แสดงชื่อและบทบาท
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $imagePath2 = "assets/images/logo/" . $com_id . "." . $com_logo;
      ...
      <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body pc-component">
              ...
              <div class="pic">
              <img src="' . $imagePath . '" class="card-img-top rounded mx-auto d-block" alt="Company Logo" style="max-width: 100px; max-height: 100px;"/>
                      </div>
