...
<div class="col-12 col-sm-8 col-md-12">
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <select class="form-select" id="role" aria-label="role" name="ep_role">
        ...
        // ดึงข้อมูล role ของพนักงานคนนั้นจากฐานข้อมูล โดยที่ $data['role'] มีค่า role_id ที่ถูกต้องจากฐานข้อมูลของพนักงาน
        $emp_role_id = $data['role']; // role_id ที่จะใช้เป็นค่า default
        ...
        if ($rs2) {
            while ($data2 = mysqli_fetch_array($rs2)) {
                $selected = ($data2['role_id'] == $emp_role_id) ? "selected" : ""; // ตรวจสอบว่า role_id ตรงกับ role ของพนักงาน
