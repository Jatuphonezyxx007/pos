...
<!-- Modal for displaying change -->
<div class="modal fade" id="changeModal" tabindex="-1" aria-labelledby="changeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="changeModalLabel">เงินทอน</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p id="changeAmount">เงินทอนของคุณคือ: </p>
      </div>
      <div class="modal-footer">
...
document.getElementById('paymentButton').addEventListener('click', function() {
    ...
    let receivedAmount = parseFloat(document.querySelector(".display").value);
    ...
    if (paymentMethod) {
        ...
        // แสดง modal แสดงเงินทอน
        document.getElementById('changeAmount').textContent = 'เงินทอนของคุณคือ: ' + change.toFixed(2) + ' บาท';
