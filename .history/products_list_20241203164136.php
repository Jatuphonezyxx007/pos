        ...
        <div class="page-block card mb-0">
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <a class="btn btn-primary" onClick="window.open('product_print.php', '_blank', 'width=960,height=1080')">
              <button type="button" class="btn btn-primary"> พิมพ์รายการสินค้า</button>
              <i class="ph ph-printer"></i></a>
              </div>
