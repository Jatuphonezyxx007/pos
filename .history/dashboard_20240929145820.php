...
<div class="col-md-6 col-xl-3">
    <div class="card bg-grd-success order-card">
        <div class="card-body">
            ...
            <p class="m-b-0 fs-6">สินค้าที่ขายเดือน<?php echo htmlspecialchars($month_message, ENT_QUOTES, 'UTF-8'); ?><span class="float-end"><?php echo ($total_items_sold); ?> ชิ้น</span></p>
        </div>
    </div>
</div>
        <div class="col-md-6 col-xl-3">
