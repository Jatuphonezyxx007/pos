...
<div class="col-md-8">
  <div class="card">
    ...
    <div class="col-10">
        <div class="row"> <!-- เริ่มต้น row ใหม่สำหรับจัดกลุ่ม -->
        <?php
        if ($rs->num_rows > 0) {
            $count = 0; // ตัวนับเพื่อแยกแถว
            while ($data = $rs->fetch_assoc()) {
                if ($count % 5 == 0 && $count > 0) {
                    echo '</div><div class="row">'; // ปิด row เดิมและเริ่ม row ใหม่
                }
                ?>
                <div class="col-2"> <!-- คอลัมน์สำหรับชื่อขนาด -->
                    <div class="row g-2 mb-2">
                        <div class="form-floating">
                            <input type="text" name="size_name[]" class="form-control" placeholder="ชื่อขนาด" value="<?= htmlspecialchars($data['size_name']); ?>" required>
                            <label>ชื่อขนาด</label>
                        </div>
                    </div>
                </div>
                <div class="col-2"> <!-- คอลัมน์สำหรับจำนวน -->
                    <div class="row g-2 mb-2">
                        <div class="form-floating">
                            <input type="number" name="size_qty[]" class="form-control" placeholder="จำนวน" value="<?= htmlspecialchars($data['qty']); ?>" required>
                            <label>จำนวน</label>
                        </div>
                    </div>
                </div>
                <div class="col-2"> <!-- คอลัมน์สำหรับจุดรีสต๊อก -->
                    <div class="row g-2 mb-2">
                        <div class="form-floating">
                            <input type="number" name="size_restock[]" class="form-control" placeholder="จุดรีสต๊อก" value="<?= htmlspecialchars($data['re_stock']); ?>" required>
                            <label>จุดรีสต๊อก</label>
                        </div>
                    </div>
                </div>
                <div class="col-2"> <!-- คอลัมน์สำหรับราคา -->
                    <div class="row g-2 mb-2">
                        <div class="form-floating">
                            <input type="text" name="size_price[]" class="form-control" placeholder="ราคา" value="<?= htmlspecialchars($data['price']); ?>" required>
                            <label>ราคารวมภาษี</label>
                        </div>
                    </div>
                </div>
                <div class="col-2"> <!-- คอลัมน์สำหรับปุ่มลบ -->
                    <div class="row g-2 mb-2">
