...
<!-- [ Header ] end -->
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <!-- Fixed right-side order summary (Right Side) -->
        <div class="col-md-4 col-lg-3">
            <div class="sticky-top">
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-success btn-lg" type="button" id="checkout-button">
                        ชำระเงิน
                    </button>
                    <button class="btn btn-danger btn-lg" type="button" id="clear-button">
                        ล้างทั้งหมด
                    </button>
                </div>
            </div>
