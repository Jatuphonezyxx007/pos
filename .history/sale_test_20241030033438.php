...
<div class="buttonscal">
  <div class="col">
  <button class="btn btn-danger w-25" data-value="AC">AC</button>
  </div>
  <br>
  <div class="col">
  <button class="btn btn-warning w-25" data-value="DEL">DEL</button>
  </div>
  <br>
  <div class="col">
  <button class="btn btn-danger w-25" data-value="%">%</button>
  </div>
  <br>
  <div class="col">
  <button class="btn btn-danger w-25" data-value="/">/</button>
