...
<!-- [ Header ] end -->
  ...
  <div class="col-12 col-md-9">
    ...
    <div class="d-flex align-items-center">
        <div class="me-2 text-start" style="flex: 0 0 auto; width: 20%;"> <!-- Adjust width as needed -->
            <p class="mb-0">ราคา</p>
        </div>
        <div style="flex: 1;">
            <p id="price-display" class="mb-0">0 บาท</p>
        </div>
    </div>
</div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $(document).on('click', '.size-button', function() {
        ...
        priceContainer.textContent = price + ' บาท';
    });
});
