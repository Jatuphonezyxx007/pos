...
<table class="table table-bordered" width="100%">
    <thead>
    <tr>
    <td width="10%" class="text-center small"><strong>
        ลำดับที่</strong><br>
...
";
    ...
    ?>
        <tr>
            <td class="text-center small fw-normal"><?=$i;?></td>
<td class="small">
    <?=$data['name'];?>
    <br>
