...
<table width="100%" id="calcu"> 
    ...
    <tr> 
        ...
        <td><input type="button-cal" value="8"></td> 
        <td><input type="button-cal" value="9"></td> 
        <td><input type="button-cal" value="1000"></td> 
    </tr> 
    <tr> 
        <td><input type="button-cal" value="4"></td> 
        <td><input type="button-cal" value="5"></td> 
        <td><input type="button-cal" value="6"></td> 
        <td><input type="button-cal" value="500"></td> 
    </tr> 
    <tr> 
        <td><input type="button-cal" value="1"></td> 
        <td><input type="button-cal" value="2"></td> 
        <td><input type="button-cal" value="3"></td> 
        <td><input type="button-cal" value="100"></td> 
    </tr> 
    <tr> 
        <td><input type="button-cal" value="."></td> 
        <td><input type="button-cal" value="0"></td> 
        <td><input type="button-cal" value="ลบ"></td> 
        <td><input type="button-cal" value="เต็ม"></td> 
    </tr>
</table>
</div>
