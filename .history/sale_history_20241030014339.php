...
$totalData = mysqli_fetch_assoc($totalResult);
$totalRows = $totalData['total'];
$totalPages = max(1, ceil($totalRows / $limit)); // อย่างน้อยต้องมี 1 หน้า
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-success btn-sm" onClick="window.open('bill_print.php?b=<?=$data['order_id'];?>', '_blank', 'width=760,height=560')"><i class="ph ph-printer"></i> ใบเสร็จ</a>
                                            </td>
                                        </tr>
                                    <?php  
                                        }
