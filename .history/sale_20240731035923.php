...
<br>
    ...
    <thead>
        <tr>
            <th width="5%" class="text-center fw-lighter">ที่</th>
            <th width="75%" class="text-center fw-lighter">สินค้า</th>
            <th width="10%" class="text-center fw-lighter">จำนวน</th>
            <th width="10%" class="text-center fw-lighter">ราคา</th>
        </tr>
    </thead>
    <tbody id="order-list">
        <!-- รายการ -->
    ...
    <tfoot>
        <tr>
            <td class="fw-lighter"><strong>รวม</strong></td>
            <td></td>
            <td class="fw-lighter" style="vertical-align: top;"><strong><?= number_format($total, 2); ?></strong></td>
            <td class="fw-lighter"><strong> บาท</strong></td>
        </tr>
    </tfoot>
</table>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('add-to-order-button').addEventListener('click', function() {
        ...
        newRow.innerHTML = `
            ...
            <td class="text-center">${productName} - ${productSize}</td>
            <td class="text-center">${quantity}</td>
            <td class="text-center">${totalPrice.toLocaleString()} บาท</td>
        `;
