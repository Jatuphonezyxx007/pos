        ...
        <div class="page-block card mb-0">
          <div class="card-body">
            ...
            <div class="page-header-title border-bottom pb-2 mb-2">
              ...
              <div class="col-md-5">
              <a>
              <button type="button" class="btn btn-primary" onClick="window.open('product_print.php', '_blank', 'width=960,height=1080')"> พิมพ์รายการสินค้า <i class="ph ph-printer"></i></button>
              </a>
              </div>
              </div>
              </div>
