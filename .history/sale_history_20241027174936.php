                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="pagination-container text-center mt-3">
                            <?php if($page > 1): ?>
                                <a href="?page=<?= $page - 1; ?>" class="btn btn-outline-success">ก่อนหน้า</a>
                            <?php endif; ?>

                            <?php for($i = 1; $i <= $totalPages; $i++): ?>
                                <a href="?page=<?= $i; ?>" class="btn btn-outline-success <?= $i == $page ? 'active' : ''; ?>"><?= $i; ?></a>
                            <?php endfor; ?>

                            <?php if($page < $totalPages): ?>
                                <a href="?page=<?= $page + 1; ?>" class="btn btn-outline-success">ถัดไป</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
