          ...
          <div class="card-header">
            ...
            <div class="card-header">
              <div class="row align-items-center">
                ...
                <select class="form-select" id="role" aria-label="role" name="ep_role" onchange="toggleCustomInput()">
                  <?php
                    include("connectdb.php");
...
function toggleCustomInput() {
        ...
        if (select.value === "other") {
            customInputContainer.style.display = "block";  // แสดงช่องกรอกข้อมูล
            customInput.required = true; // ทำให้ช่องกรอกข้อมูลเป็น required
        } else {
            customInputContainer.style.display = "none";  // ซ่อนช่องกรอกข้อมูล
            customInput.required = false; // ยกเลิก required
        }
    }
