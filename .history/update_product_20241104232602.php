...
<div class="col-md-8">
  ...
  <div class="row g-2 mb-2 position-relative">
    <label for="size_name" class="form-label">ชื่อขนาด</label>
    <input id="size_name" name="size_name" type="text" class="form-control" value="<?= $data['size_name']; ?>">
  </div>
</div>
<div class="col-2">
  <div class="row g-2 mb-2 position-relative">
    <label for="qty" class="form-label">จำนวน</label>
    <input id="qty" name="qty" type="text" class="form-control" value="<?= $data['qty']; ?>">
  </div>
</div>
<div class="col-2">
  <div class="row g-2 mb-2 position-relative">
    <label for="re_stock" class="form-label">จุดรีสต๊อก</label>
    <input id="re_stock" name="re_stock" type="text" class="form-control" value="<?= $data['re_stock']; ?>">
  </div>
</div>
<div class="col-2">
  <div class="row g-2 mb-2 position-relative">
