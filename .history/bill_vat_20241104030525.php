  ...
  <tbody>
    ...
    <thead>
        <tr>
            ...
            <td width="60%" class="text-center small"><strong>รายการสินค้า</strong><br>
                <span class="small">Description</span>
            </td>
            <td width="10%" class="text-center small"><strong>จำนวน</strong><br>
                <span class="small">Quantity</span>
            </td>
            <td width="10%" class="text-center small"><strong>ราคาต่อหน่วย</strong><br>
                <span class="small">Unit Price</span>
            </td>
            <td width="10%" class="text-center small"><strong>รวม</strong><br>
                <span class="small">Amount (Bath)</span>
            </td>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" class="text-center font-table">รวมเงินทั้งสิ้น</td>
            <td class="text-center font-table"><strong><?=number_format($total, 2);?></strong> บาท</td>
        </tr>
    </tbody>
</table>
