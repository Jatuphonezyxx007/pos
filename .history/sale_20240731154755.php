  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container">
<!-- ตารางเครื่องคิดเลข -->
<table width="100%" id="calcu"> 
    <tr> 
        <td colspan="4"> 
            <input class="form-control text-end w-100" type="text" id="result" readonly value="0"> 
        </td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('7')">7</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('8')">8</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('9')">9</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('1000')">1000</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('4')">4</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('5')">5</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('6')">6</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('500')">500</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('1')">1</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('2')">2</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('3')">3</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('100')">100</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('.')">.</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100" onclick="addToResult('0')">0</button></td> 
        <td width="20%"><button class="btn btn-secondary w-100" onclick="deleteLastChar()"><i class="ph ph-backspace"></i></button></td> 
        <td width="40%"><button class="btn btn-primary w-100" onclick="calculateTotal()">เต็ม</button></td> 
    </tr>
</table>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@phosphor-icons/web@2.0.1/dist/phosphor.min.js"></script>
...
// ฟังก์ชันเพื่อเพิ่มตัวเลขหรือสัญลักษณ์ไปยังช่องผลลัพธ์
function addToResult(value) {
    let result = document.getElementById('result');
    // ถ้าช่องผลลัพธ์แสดง '0' หรือเป็นค่าว่าง ให้อัพเดตด้วยค่าใหม่
...
// ฟังก์ชันเพื่อลบตัวเลขสุดท้ายจากช่องผลลัพธ์
function deleteLastChar() {
    let result = document.getElementById('result');
    // ลบตัวอักษรสุดท้าย ถ้าช่องผลลัพธ์เป็นค่าว่างให้แสดง '0'
    result.value = result.value.slice(0, -1) || '0';
}

// ฟังก์ชันเพื่อคำนวณราคารวมจากตาราง
function calculateTotal() {
    let result = document.getElementById('result').value;
    let total = parseFloat(result) || 0; // ถ้าค่าเป็น NaN ให้ใช้ 0 แทน

    // สมมุติว่าเราอัปเดตราคาในตารางของคุณที่มี id="order-list"
    updateTotalPrice();

    // แสดงผลรวมในช่องผลลัพธ์
    document.getElementById('result').value = total.toLocaleString();
}

// ฟังก์ชันอัปเดตราคารวมจากตารางสินค้า
function updateTotalPrice() {
    let orderList = document.getElementById('order-list');
    let total = 0;
