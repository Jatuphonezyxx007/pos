...
<table width="100%" id="calcu"> 
    ...
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">7</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">8</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">9</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100">1000</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">4</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">5</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">6</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100">500</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">1</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">2</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">3</button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100">100</button></td> 
    </tr> 
    <tr> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">.</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100">0</button></td> 
        <td width="20%"><button class="btn btn-outline-secondary w-100"><i class="ph ph-backspace"></i></button></td> 
        <td width="40%"><button class="btn btn-outline-secondary w-100">เต็ม</button></td> 
    </tr>
</table>
