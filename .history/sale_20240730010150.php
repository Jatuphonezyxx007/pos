...
<!-- [ Header ] end -->
  ...
  <div class="col-12 col-md-9">
    ...
    include("connectdb.php");
    @$src = $_POST['src'];
    $sql = "SELECT products.*, size.size_name, MIN(size.price) AS min_price, MAX(size.price) AS max_price 
    FROM `products`
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- Size name button -->
                                <button type="button" class="btn btn-outline-secondary" id="size-name-btn"></button>
...
// $(document).ready(function() {
//     // เมื่อคลิกที่ปุ่มขนาด
//     $('.size-button').on('click', function() {
//         // ดึงค่า id ของขนาดที่เลือก
//         var selectedSize = $(this).data('size');

//         // ส่งคำขอ AJAX ไปยัง fetch_size.php
//         $.ajax({
//             url: 'fetch_sizes.php',
//             type: 'POST',
//             data: { id: selectedSize },
//             success: function(response) {
//                 // แสดงผลลัพธ์ในพื้นที่ที่กำหนด
//                 $('#sizes-container').html(response);
...
//             }.bind(this),
//             error: function() {
//                 alert('Error fetching size data.');
//             }
//         });
//     });
// });
