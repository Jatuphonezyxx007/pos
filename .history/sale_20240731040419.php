...
<br>
    ...
    <thead>
        <tr>
            ...
            <th width="75%" class="text-center fst-normal">สินค้า</th>
            <th width="10%" class="text-center fst-normal">จำนวน</th>
            <th width="10%" class="text-center fst-normal">ราคา</th>
        </tr>
    </thead>
    <tbody id="order-list">
    ...
    <tfoot>
        <tr>
            <td class="fst-normal"><strong>รวม</strong></td>
            <td></td>
            <td class="text-center fst-normal" style="vertical-align: top;"><strong><?= number_format($total, 2); ?></strong></td>
            <td class="fst-normal"><strong> บาท</strong></td>
        </tr>
    </tfoot>
</table>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('add-to-order-button').addEventListener('click', function() {
        ...
        newRow.innerHTML = `
            ...
            <td class="text-start fst-normal">${productName} - ${productSize}</td>
            <td class="text-end">${quantity}</td>
            <td class="text-center">${totalPrice.toLocaleString()}</td>
        `;
