        ...
        <div class="col-md-12">
          ...
          <div class="card-header">
            ...
            <div class="card-body pc-component">
              ...
              <div class="col-4">
              <div class="form-floating">
                  <input name="cus_last" type="text" class="form-control" id="cus_last" placeholder="นามสกุล" required>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-9">
              <div class="form-floating">
                  <input name="cus_taxid" type="text" class="form-control" id="cus_taxid" placeholder="หมายเลขผู้เสียภาษี" required>
                  <label for="floatingInputGrid">หมายเลขประจำตัวผู้เสียภาษี</label> 
                </div>
              </div>          
            </div>
            <br>
