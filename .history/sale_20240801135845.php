...
<table width="100%" id="calcu"> 
    ...
    <tr> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="7" onclick="addToResult('7')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="8" onclick="addToResult('8')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="9" onclick="addToResult('9')"></td> 
        <td width="40%"><input class="btn-cal fs-4" type="button" value="1000" onclick="addToResult('1000')"></td> 
    </tr> 
    <tr> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="4" onclick="addToResult('4')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="5" onclick="addToResult('5')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="6" onclick="addToResult('6')"></td> 
        <td width="40%"><input class="btn-cal fs-4" type="button" value="500" onclick="addToResult('500')"></td> 
    </tr> 
    <tr> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="1" onclick="addToResult('1')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="2" onclick="addToResult('2')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="3" onclick="addToResult('3')"></td> 
        <td width="40%"><input class="btn-cal fs-4" type="button" value="100" onclick="addToResult('100')"></td> 
    </tr> 
    <tr> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="."></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="0" onclick="addToResult('0')"></td> 
        <td width="20%"><input class="btn-cal fs-4" type="button" value="ลบ" onclick="deleteLastChar()"></td> 
        <td width="40%"><input class="btn-cal fs-4" type="button" value="เต็ม" onclick="calculateTotal()"></td> 
    </tr>
</table>
