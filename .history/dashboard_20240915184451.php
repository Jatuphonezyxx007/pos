...
$sql_employee_sales = "
    SELECT e.emp_name, o.order_date, SUM(o.order_total) AS total_sales
    FROM orders o
    JOIN employees e ON o.emp_id = e.emp_id
    GROUP BY e.emp_name, o.order_date
...
const labels = <?php echo json_encode($sales_data[array_key_first($sales_data)]['dates']); ?>;
    const data = {
        labels: labels,
