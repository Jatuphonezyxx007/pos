    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col text-center font-table">
                <p>ลงชื่อ ________________________________________________________ ผู้รับสินค้า</p>
            </div>
            <div class="col text-center font-table">
            <p>ลงชื่อ ________________________________________________________ ผู้ขาย</p>
            </div>
