...
<!-- [ Header ] end -->
  ...
  <div class="col-12 col-md-9">
    ...
    <div class="input-group input-group-sm">
      <button class="btn btn-danger btn-sm" type="button" onclick="decreaseQuantity()">-</button>
      <input class="form-control form-control-sm mx-2" type="number" id="quantity" min="1" value="1">
      <button class="btn btn-success btn-sm" type="button" onclick="increaseQuantity()">+</button>
    </div>
  </div>
</div>
