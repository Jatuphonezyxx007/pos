...
.font-xsmall {
        font-size: 0.75rem; /* หรือคุณสามารถใช้ขนาดที่เล็กกว่าที่คุณต้องการ */
    }
...
?>
    ...
    <div class="row">
        <div class="col-7">
            <h5 class="text-start">บริษัท <?=$data['com_name'];?></h5>
        </div>
...
<div class="row">
    <div class="col-8">
        <div class="text-start font-header">
            ...
            <p class="mb-1">เบอร์โทร: <?=$data['com_phone'];?></p>
...
<div class="row">
  <div class="col-5">
    <div class="text-start font-header">
      <p>หมายเลขคำซื้อ: <?=$data['order_id'];?></p>
    </div>
  </div>
  <div class="col-7">
    <div class="text-end font-header">
      <p>พนักงานขาย: <?=$data['emp_name'];?></p>
    </div>
  </div>
</div>
...
";
    ...
    ?>
        <tr>
            ...
            <td class="small"><?=$data['name'];?><br><?=$data['size_name'];?></td>
