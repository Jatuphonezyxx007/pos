...
<!-- [ Header ] end -->
  ...
  <div class="col-12 col-md-9">
    ...
    <div class="card h-100">
        <img src="assets/images/products_2/<?=$data['id'];?>.<?=$data['img'];?>" class="card-img-top" alt="" style="object-fit: cover; width: 100%; height: 240px;">
        <div class="card-body">
            <h8 class="card-title d-inline-block text-truncate" style="max-width: 100%;"><?=$data['name'];?></h8>
            <p class="card-text">
...
<div class="col-12 col-md-3 fixed-col">
    ...
    <div class="d-grid gap-2 mt-3">
        <button class="btn btn-success" type="button" id="pay-button">ชำระเงิน</button>
        <button class="btn btn-danger" type="button" id="clear-order-button">ล้างทั้งหมด</button>
    </div>
</div>
