...
<!-- [ Header ] end -->
  ...
  <div class="pc-container">
    ...
    <?php
    // กำหนดหมายเลขหน้าที่จะแสดง
    $start = max(1, $page - 2); // เริ่มต้นจากหน้าแรก หรือ 2 หน้าเมื่อมีข้อมูลมากพอ
    $end = min($totalPages, $start + 4); // จำกัดจำนวนหน้าแสดงไม่เกิน 5 หน้า

    // ถ้าหมายเลขหน้าต่ำกว่า 5 ให้แสดงจาก 1 ถึง totalPages
    if ($totalPages < 5) {
        $start = 1;
        $end = $totalPages;
    }
