        ...
        <div class="page-block card mb-0">
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <a class="btn btn-success btn-sm" onClick="window.open('bill_vat.php?b=<?=$data['order_id'];?>', '_blank', 'width=960,height=1080')"><i class="ph ph-printer"></i> พิมพ์รายการสินค้า</a>
              </div>
