  ...
  <div class="modal-dialog">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row g-2">
                <div class="col-3">
                    <button class="btn btn-outline-secondary w-100" onclick="addNumber('7')">7</button>
                </div>
                <div class="col-3">
                    <button class="btn btn-outline-secondary w-100" onclick="addNumber('8')">8</button>
                </div>
                <div class="col-3">
                    <button class="btn btn-outline-secondary w-100" onclick="addNumber('9')">9</button>
                </div>
                <div class="col-3">
                    <button class="btn btn-info w-100" onclick="addNumber('1000')">1000</button>
                </div>
            </div>
            <!-- ... (ปุ่มอื่น ๆ) ... -->
            <div class="row g-2 mt-1">
                ...
                <div class="col-3">
                    <button class="btn btn-success w-100" id="actionButton" onclick="handleAction()">เต็ม</button>
                </div>
            </div>
        </div>
    </div>
