...
// ตรวจสอบว่ามีการกำหนด id ที่ส่งผ่าน URL หรือไม่
if (isset($_GET['id'])) {
  $id = $_GET['id'];

  // สร้างคำสั่ง SQL เพื่อเชื่อมตาราง products, size และ type โดยดึงข้อมูลขนาดทั้งหมดของสินค้า
  ...
  // ตรวจสอบผลลัพธ์ที่ได้จากการ query
  if ($rs) {
      // Loop เพื่อดึงข้อมูลทั้งหมดที่เกี่ยวข้องกับขนาดของสินค้านั้นๆ
