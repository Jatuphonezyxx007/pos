    ...
    <div class="card-body pc-component">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-2">
          ...
          <input name="p_name" type="text" class="form-control" value="<?= $data['size_name']; ?>"> 
          </div> <!-- ปิดแถวของปุ่ม -->
        </div>
        <div class="col-2">
          <div class="row g-2 mb-2">
        ...
        <div class="col-2">
          <div class="row g-2 mb-2">
          <input name="p_name" type="text" class="form-control" value="<?= $data['qty']; ?>"> 
          </div> <!-- ปิดแถวของปุ่ม -->
        </div>
        <div class="col-2">
          <div class="row g-2 mb-2">
          <input name="p_name" type="text" class="form-control" value="<?= $data['re_stock']; ?>" placeholder="จุดรีสต๊อก"> 
          </div> <!-- ปิดแถวของปุ่ม -->
        </div>
        <div class="col-2">
          <div class="row g-2 mb-2">
          <input name="p_name" type="text" class="form-control" value="<?= $data['price']; ?>"> 
          </div> <!-- ปิดแถวของปุ่ม -->
        </div>
        <div class="col-2">
          <div class="row g-2 mb-2">
