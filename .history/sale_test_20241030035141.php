...
function calculateTotalPrice() {
    ...
    rows.forEach(row => {
        ...
        let price = parseFloat(row.querySelector('.price').textContent.replace(/[^0-9.-]+/g, "")) || 0;
        totalPrice += quantity * price; // คำนวณราคารวมตามจำนวนและราคา
    });
    ...
    if (selectedValue == '2') { // 2 คือ paymethod_id ของ PromtPay
        ...
        const calculate = (btnValue) => {
            ...
            if (btnValue === "=") {
                ...
                output = calculateTotalPrice().toFixed(2); // คำนวณราคารวม
            } else if (btnValue === "AC") {
