...
// 1. ค้นหาบิลที่มียอดขายสูงสุดในเดือนปัจจุบัน
$sql_max_order = "
...
if ($result_max_order->num_rows > 0) {
    ...
    $max_order_total = $row_max_order['order_total'];
    $emp_name = $row_max_order['emp_name'];
    
    echo "บิลที่มียอดขายสูงสุดในเดือนนี้: " . $max_order_total . "<br>";
    echo "ชื่อพนักงานที่ขายบิลนี้: " . $emp_name;
} else {
    echo "ไม่พบข้อมูลบิลในเดือนนี้.";
}
